...
int Child2(char *arg)
{
   ...
   for (i = 0; i< 5; i++) {
      ...
      console("Child_2%d(): writing to term%d\n", unit,unit);
...
int start4(char *arg)
{
   ...
   console("start4(): Spawn eight children.  \n");
   console("          4 write 5 lines to a diff terminal.\n");
   console("          4 read 5 lines to a diff terminal.\n");
